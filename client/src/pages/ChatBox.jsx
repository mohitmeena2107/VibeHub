...
const ChatBox = () => {
  ...
  return user && (
    <div className='flex flex-col h-screen'>
        ...
        <div className='space-y-4 max-w-4xl mx-auto'>
          {
            messages.toSorted((a,b) => new Date(a.createdAt)- new Date(b.createdAt)).map((message,index)=>(
              <div key={index} className={`flex flex-col ${message.from_user_id === user._id?'items-start':'items-end'}`}>
      ...
      <div className='px-4 '>
        <div className='flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-'>
          ...
          <label htmlFor="image">
            {
              ...
              <ImageIcon className='sixe-7 text-gray-400 cursor-pointer'/>
            }
