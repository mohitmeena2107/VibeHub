  ...
  return (
    <div key={user._id} className='p-4 pt-6 flex flex-col justify-between w-72 shadow border border-gray-200 rounded-md'>
      ...
      <div className='flex mt-4 gap-2'>
        ...
        <button onClick={handleConnect} className='size-10 flex items-center justify-center text-sm rounded bg-gray-100 hover:bg-gray-200 text-gray-800 active:scale-95 transition cursor-pointer group'>
